...
def topbar():
    ...
    <div class="topbar">
        ...
        <div class="subtitle">Premium Dashboard V3.3</div>
    </div>
...
def home():
    ...
    html += "<div class='trade-box'><b>MARKET OVERVIEW</b><br><br>"
    for coin in scanner.market_data[:5]:
        html += f"{coin['symbol']} | {coin['signal']} | Score {coin['score']}<br>"
    html += "</div>"
...
def scanner_page():
    ...
    for c in scanner.market_data:
        color=""
        if c['signal']=="BUY": color="green"
        elif c['signal']=="STRONG BUY": color="green"
        elif c['signal']=="WATCH": color="yellow"
        else: color=""
